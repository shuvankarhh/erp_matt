<x-modal-form title="Add Communication" action="{{ route('communications.store',['project' => $projectId]) }}">   
    ...
    <br>
    <textarea class="mt-2 w-full" name="summary" id="" cols="10" rows="5" placeholder="Enter summary ..."></textarea>
