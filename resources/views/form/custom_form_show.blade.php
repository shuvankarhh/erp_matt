...
<div class="flex flex-col gap-2 border border-gray-300 p-4 bg-slate-50">
    ...
    <div class="flex justify-between items-center">
        <h3 class="font-bold text-xl text-gray-500">Edit Custom Form</h3>
    ...
    <div class="flex-grow-0  p-4">
        <form action="{{ route('custom-form.update', ['custom_form' => $customeform->id]) }}" method="POST">    
            ...
            <div class="mt-4">
                ...
                <select class="form-input mt-2 w-1/4 " >
            ...
            <div class="mt-4">
                <label for="display_at" class="text-lg font-semibold">Display at</label>
            ...
            <div class="flex justify-start items-center">
                <div class="flex justify-end items-center mt-4">
                    <div class="flex gap-2 items-center">
                        <button class="bg-green-500 text-white font-medium py-2 px-4 rounded hover:bg-green-600 menu-icon">
                            {{-- <i class="mgc_add_line font-bold"></i>  --}}
                            Save
                        </button>
                    </div>
                </div>
