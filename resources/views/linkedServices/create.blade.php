<x-modal-form title="Add Linked service" action="{{ route('linked-services.store',['project' => $projectId]) }}">   

    <x-input class="mb-2" label="Service Name" name="service_name" value="{{ old('service_name') }}" placeholder="Enter service name" required />
    ...
    <x-input class="mb-2" label="Insurance Policy" name="insurance_policy" value="{{ old('insurance_policy') }}" placeholder="Enter Insurance Policy"  />
    ...
    <br>
    <textarea class="mt-2 w-full" name="notes" id="" cols="10" rows="5" placeholder="Enter notes ..."></textarea>
