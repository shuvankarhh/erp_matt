        ...
        <div class="overflow-x-auto">
            ...
            <div class="createCustomer mt-2 hidden">
                ...
                <div class="flex justify-between gap-3 mt-1 p-2"> 
                    ...
                    <div class="flex flex-col w-full md:w-1/2">
                        <label for="contact-organisation-name" class="mb-1 text-gray-700 font-medium">Organisation Name</label>
                        <input 
                            type="text" 
                    ...
                    <!-- Contact First Name -->
                    <div class="flex flex-col w-full md:w-1/2">
                        <label for="contact-first-name" class="mb-1 text-gray-700 font-medium">Contact first Name</label>
                        <input 
                            type="text" 
                    ...
                    <!-- Contact Last Name -->
                    <div class="flex flex-col w-full md:w-1/2">
                        <label for="contact-last-name" class="mb-1 text-gray-700 font-medium">Contact Last Name</label>
                        <input 
                            type="text" 
                ...
                <div class="flex justify-between gap-3 mt-1 p-2">
                    ...
                    <div class="flex flex-col w-full md:w-1/2">
                        <label class="mb-1 text-gray-700 font-medium"> Country <span style="color:red">*</span></label>
                    ...
                    <div class="flex flex-col w-full md:w-1/2">
                        <label class="mb-1 text-gray-700 font-medium"> State <span style="color:red">*</span></label>
            ...
            <div class="insuranceInformations hidden">
                ...
                <div class="flex justify-between gap-3 mt-1 p-2">
                    <!-- Project Type -->
                    <div class="flex flex-col w-full md:w-1/2">
                        <label for="insurance-company" class="mb-1 text-gray-700 font-medium">Insurance Company</label>
                        <input 
                            type="text" 
                    ...
                    <!-- Service Type -->
                    <div class="flex flex-col w-full md:w-1/2">
                        <label for="insurance-policy" class="mb-1 text-gray-700 font-medium">Insurance Policy</label>
                        <input 
                            type="text" 
                            id="insurance-policy"
                    ...
                    <!-- Property Type -->
                    <div class="flex flex-col w-full md:w-1/2">
                        <label for="insurance_claim-number" class="mb-1 text-gray-700 font-medium">Insurance Claim Number</label>
                        <input 
                            type="text" 
            ...
            <div class="flex justify-between mt-3">
                ...
                <select name="referralSource" class="w-1/2 rounded" id="referralSource" onchange="referralSources()" >
                    <option value="">---select---</option>
