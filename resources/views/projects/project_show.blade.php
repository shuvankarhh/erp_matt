...
@section('content')
    <style>
        .active {
            background-color: rgb(45, 240, 185) !important;
            /* To override Tailwind if needed */
            color: rgb(95, 95, 95) !important;
            /* Ensure the text color matches your requirement */
        }
    </style>
        ...
        <div id="default-offcanvas"
            ...
            <div class="p-5">
                ...
                <div class="space-y-2 mt-4 ">
                    ...
                    <a href="javascript:void(0);" onclick="changeMenu('overview')"
                        class="flex items-center py-2 px-4 text-sm rounded text-gray-500 hover:bg-slate-100 hover:text-slate-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300 active"
                        id="overview">
                        <i data-feather="home" class="me-3.5 w-4"></i>
                        <span>Overview</span>
                    </a>

                    <a href="javascript:void(0);" onclick="changeMenu('inspectionPage')"
                    ...
                    {{-- Previous Code --}}
                    {{-- <a href="javascript:void(0);" onclick="changeMenu('makeSafePage')"
                        class="flex items-center py-2 px-4 text-sm rounded text-gray-500 hover:bg-slate-100 hover:text-slate-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300"
                        id="makeSafePage">
                        <i data-feather="file-text" class="me-3.5 w-4"></i>
                        <span>Make Safe</span>
                    ...
                    <a href="javascript:void(0);" onclick="changeMenu('scope')"
                        class="flex items-center py-2 px-4 text-sm rounded text-gray-500 hover:bg-slate-100 hover:text-slate-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300"
                        id="scope">
                        <i data-feather="file-text" class="me-3.5 w-4"></i>
                        <span>Scope</span>
                    </a>
                    <a href="javascript:void(0);" onclick="changeMenu('estimate')"
                        class="flex items-center py-2 px-4 text-sm rounded text-gray-500 hover:bg-slate-100 hover:text-slate-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300"
                        id="estimate">
                        <i data-feather="file-text" class="me-3.5 w-4"></i>
                        <span>Estimate</span>
                    ...
                    <a href="javascript:void(0);" onclick="changeMenu('onsiteWorks')"
                        class="flex items-center py-2 px-4 text-sm rounded text-gray-500 hover:bg-slate-100 hover:text-slate-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300"
                        id="onsiteWorks">
                    ...
                    <a href="javascript:void(0);" onclick="changeMenu('weather')"
                        class="flex items-center py-2 px-4 text-sm rounded text-gray-500 hover:bg-slate-100 hover:text-slate-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300"
                        id="weather">
                    ...
                    <a href="javascript:void(0);" onclick="changeMenu('media')"
                        class="flex items-center py-2 px-4 text-sm rounded text-gray-500 hover:bg-slate-100 hover:text-slate-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300"
                        id="media">
                    ...
                    <a href="javascript:void(0);" onclick="changeMenu('notes')"
                        class="flex items-center py-2 px-4 text-sm rounded text-gray-500 hover:bg-slate-100 hover:text-slate-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300"
                        id="notes">
                    ...
                    <a href="javascript:void(0);" onclick="changeMenu('timeline')"
                        class="flex items-center py-2 px-4 text-sm rounded text-gray-500 hover:bg-slate-100 hover:text-slate-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300"
                        id="timeline">
