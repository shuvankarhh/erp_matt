<html>
    ...
    <body style="background-color: #c7f9ed">
        <div class="d-flex justify-content-between" style="background-color: white">
                ...
                <div class="ml-2">
                    <img src="{{ asset('storage/images/' . $website_settings->company_logo) }}" alt="logo" style="max-height: 60px; max-width: 200px; margin-bottom: 10px; margin-right: 15px;">
                </div>
        ...
        <div class="d-flex justify-content-center"  >
            <p style="weight:90%;font-size:100%;padding:18%"> <b>*Under Construction*</b><br> 
                Thank you for visiting our website. We're currently working to develop all the features <br>of this website. Exciting changes are on the way!</p>
        </div>
