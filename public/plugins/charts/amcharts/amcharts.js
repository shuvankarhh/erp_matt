    ...
    d.ValueAxis = d.Class({
        ...
        zoomToValues: function(a, b, c) {
            ...
            if (this.minZoom != a || this.maxZoom != b) return this.minZoom = a, this.maxZoom = b, e = {
                    type: "axisZoomed"
                }, e.chart = this.chart, e.valueAxis = this, e.startValue =
                            ...
                            if (!isNaN(W)) {
                                ...
                                if (!(W < Qb && ob < Qb || W > Rb && ob > Rb)) {
                                    ...
                                    if (t) {
                                        ...
                                        J = d.roundTo(J, 2);
                                        ba = d.roundTo(ba, 2);
                                        S < n + Z * H && 0 < J && (this.showOnAxis && (R -= Q / 2), va = new d.Cuboid(h, J, ba, H - a.d3x, Q - a.d3y, Na, Va, da, Ca, this.lineAlpha, ga, w, t, ea, bb, mb, aa), v.columnHeight = Math.abs(ba), v.columnWidth = Math.abs(J))
                                    }
                                }
                                if (va) {
                                    za = va.set;
...
(function() {
    ...
    d.Bezier = d.Class({
        construct: function(a, b, c, e, h, f, g, k, l, m, n) {
            ...
            h = [];
            for (l = 0; l < b.length; l++) isNaN(b[l]) || isNaN(c[l]) ? (e += this.drawSegment(h), l < b.length - 1 && (e += "L" + b[l + 1] + "," + c[l + 1]), h = []) : h.push({
                x: Number(b[l]),
                y: Number(c[l])
            });
...
(function() {
    ...
    d.AmDraw = d.Class({
        construct: function(a, b, c, e) {
            d.SVG_NS = "https://www.w3.org/2000/svg";
            d.SVG_XLINK = "https://www.w3.org/1999/xlink";
