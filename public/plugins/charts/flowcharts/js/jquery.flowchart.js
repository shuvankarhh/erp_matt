...
// "colorize" the widget name
    $.widget("flowchart.flowchart", {
        ...
        options: {
            ...
            defaultLinkColor: '#2441a7',
            defaultSelectedLinkColor: '#e91e63',
            linkWidth: 10,
            grid: 20,
        ...
        _create: function () {
            ...
            var shape = document.createElementNS("https://www.w3.org/2000/svg", "line");
            ...
            shape.setAttribute("stroke", "#9a9a9a");
        ...
        _drawLink: function (linkId) {
            ...
            var overallGroup = document.createElementNS("https://www.w3.org/2000/svg", "g");
            this.objs.layers.links[0].appendChild(overallGroup);
            linkData.internal.els.overallGroup = overallGroup;

            var mask = document.createElementNS("https://www.w3.org/2000/svg", "mask");
            ...
            var shape = document.createElementNS("https://www.w3.org/2000/svg", "rect");
            ...
            var shape_polygon = document.createElementNS("https://www.w3.org/2000/svg", "polygon");
            ...
            var shape_path = document.createElementNS("https://www.w3.org/2000/svg", "path");
            ...
            var shape_rect = document.createElementNS("https://www.w3.org/2000/svg", "rect");
        ...
        createOperator: function (operatorId, operatorData) {
            ...
            // https://stackoverflow.com/questions/2930092/jquery-draggable-with-zoom-problem
        ...
        // Found here : https://stackoverflow.com/questions/5560248/programmatically-lighten-or-darken-a-hex-color-or-rgb-and-blend-colors
