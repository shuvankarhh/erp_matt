...
(function (root, factory) {
    ...
    var DateRangePicker = function(element, options, cb) {
        ...
        this.applyClass = 'btn btn-primary btn-rounded';
        this.cancelClass = 'btn btn-warning btn-rounded';
    ...
    DateRangePicker.prototype = {
        ...
        renderCalendar: function(side) {
            ...
            var arrow = this.locale.direction == 'ltr' ? {left: 'flaticon-caret-left', right: 'flaticon-caret-right'} : {left: 'flaticon-caret-right', right: 'flaticon-caret-left'};
