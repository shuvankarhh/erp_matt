...
function initMap() {
  var map = new google.maps.Map(document.getElementById('other_map1'), {
    zoom: 11,
  ...
  /*----------Other_map2 start------------*/
  map = new google.maps.Map(document.getElementById('other_map2'), {
    zoom: 13,
  ...
  /*----------Other_map3 start------------*/
  var map = new google.maps.Map(document.getElementById('other_map3'), {
  ...
  /*----------Other_map4 start------------*/
  var map = new google.maps.Map(document.getElementById('other_map4'), {
  ...
  /*----------Other_map5 start------------*/
  var map = new google.maps.Map(document.getElementById('other_map5'), {
  ...
  /*----------Other_map6 start------------*/
  var map = new google.maps.Map(document.getElementById('other_map6'), {
    zoom: 4,
  ...
  /*----------Other_map7 start------------*/
  var map = new google.maps.Map(document.getElementById('other_map7'), {
    zoom: 13,
  ...
  /*----------Other_map8 start------------*/
  var map = new google.maps.Map(document.getElementById('other_map8'), {
    zoom: 13,
  ...
  /*----------Other_map9 start------------*/
   var map = new google.maps.Map(document.getElementById('other_map9'), {
    zoom: 14,
  ...
  /*----------Other_map10 start------------*/
  map10 = new google.maps.Map(document.getElementById('other_map10'), {
...
/*----------Other_map10 start------------*/
function rotate90() {
  var heading = map10.getHeading() || 0;
  map10.setHeading(heading + 90);
}
